...
def merge(Pipeline p) {
    ...
    def pr_merge_response = httpRequest authentication: 'github-personal',
        httpMode: 'PUT',
        url: "https://api.github.com/repos/${p.git_user}/${p.repository_name}/pulls/${p.pr_num}/merge",
        validResponseCodes: '200,405,409', wrapAsMultipart: false
    ...
    if (parsed_pr_merge_response.containsKey("merged")){
        ...
        def pr_check_response = httpRequest authentication: 'github-personal',
            httpMode: 'GET',
            url: "https://api.github.com/repos/${p.git_user}/${p.repository_name}/pulls/${p.pr_num}",
            validResponseCodes: '200,405,409', wrapAsMultipart: false
